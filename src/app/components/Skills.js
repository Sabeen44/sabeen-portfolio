...
function SkillCard({ skill, index }) {
  ...
  return (
    <motion.div
      ...
      className=" border border-rose-200 p-8 flex flex-col gap-6 bg-white hover:border-rose-300 transition-colors " 
      
      // {`border ${skill.border} p-8 flex flex-col gap-6 bg-white hover:border-rose-300 transition-colors`}
    >

      {/* Card header */}
      <div className="flex items-center justify-between">
        <span className= "text-rose-400 font-display text-sm font-bold  ">
          {skill.category}
        </span>
        {/* ${skill.color} */}
